    ...
    <div className="space-y-3">
      ...
      {putintsevaFlag &&
        Object.entries(picks).some(([m, s]) => {
          ...
          <div className="rounded-lg bg-danger/15 text-danger text-xs text-left py-2 px-3 font-semibold leading-snug">
            {putintsevaRisk ? (
              <>
                🎯 <b>ПРАВИЛО ПУТИНЦЕВА.</b> В прошлый раз ты уже лил очевидное (кэф &lt; 1.45). Поставишь это снова — мы тебе нахуй колени прострелим: за <b>весь этот купон 0 очков на плюс</b>, а минусы за неугаданное останутся. Думай.
              </>
            ) : (
              <>
                🎯 У тебя включено <b>правило Путинцева</b>. Это очевидная ставка (кэф &lt; 1.45). Будешь делать такие <b>два матча подряд</b> — прострелим колени и очки за купон не дадим (минусы оставим). Не наглей.
              </>
            )}
          </div>
        )}
